...
*Above: 192 predictions generated by 192 different parameter combinations (more detail in ``\project_result\parameter_settings_for_batch_run.py``. Each parameter combination run was done with ``Total N`` at 10,000.*
